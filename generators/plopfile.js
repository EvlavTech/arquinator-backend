    ...
    plop.setGenerator('crud', {
        ...
        actions: [
            ...
            },
            {
                type: 'add',
                path:
                    '../src/app/repository/{{pascalCase (getName name)}}Repository.ts',
                templateFile: 'templates/Repository.ts.hbs',
            },
            {
                type: 'add',
                path:
                    '../src/app/services/{{pascalCase (getName name)}}Service.ts',
                templateFile: 'templates/Service.ts.hbs',
            },
            {
                type: 'add',
                path:
                    '../src/app/controllers/{{pascalCase (getName name)}}Controller.ts',
